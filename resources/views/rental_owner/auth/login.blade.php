<x-guest-layout>
    ...
    <div class="form-group">
        ...
        <a href="{{ route('rental_owner.login') }}" class="user-type-link btn2" style="background-color: blue;color:white;border-color:blue;">
            Rental Owner
        </a>
    </div>
    ...
    <form method="POST" action="{{ route('rental_owner.login') }}">
        @csrf
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-blue-600 hover:text-blue-900" style="color: white;" href="{{ route('rental_owner.register') }}">
                {{ __('Register here') }}
            </a>
